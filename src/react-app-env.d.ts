...
declare module 'react-digraph' {
    ...
    export type INodeProps = {
        ...
        renderNode?: (nodeRef: any, data: any, id: string, selected: boolean, hovered: boolean) => any;
    ...
    export type NodesMap = { [key: string]: INodeMapNode };

    export type EdgesMap = { [key: string]: IEdgeMapNode };
